...
public class Juego extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lbl_reiniciar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(0, 0, 0)
                .addComponent(lbl_reiniciar, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGap(0, 0, 0))
        );
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        ...
        Estadistica est = new Estadistica(tab.getJugador1(), tab.getJugador2(),tab.getVictoriasX(), tab.getVictoriasO(), tab.getEmpate());
        frm.setSize(est.getWidth(), est.getHeight());
